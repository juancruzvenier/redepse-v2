...
export default function RegistroEntrenadores() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (!response.ok) throw new Error("Error al registrar entrenador");

      // Refrescar la lista de tutores después de agregar uno nuevo
      const refreshResponse = await fetch("/api/entrenadores");
                ...
                <table className={styles.table}>
                  ...
                  <tbody>
                    {entrenadores.map((entrenador) => (
                      <tr key={entrenador.dni_ent}>
                        <td>{entrenador.dni_ent}</td>
                        <td>{entrenador.nombre}</td>
                        <td>{entrenador.apellido}</td>
                        <td>{entrenador.fecha_nac}</td>
                        <td>{entrenador.email || "No especificado"}</td>
                        <td>{entrenador.telefono || "No especificado"}</td>
